...
| Quick access | Toolbar actions, QAT menu show/hide control, customization entry points, top/bottom placement | Partial | `main.cpp`, `--grab-qat-hidden-preview`, preview screenshot |
